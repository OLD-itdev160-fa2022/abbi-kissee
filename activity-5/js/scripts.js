/**
 * Wrap everything in an IIFE (Immediately Invoked Funcion Expression) to keep
...
(function() {
    ...
    var data = [
        ...
        },
        {
            ...
            author: 'Glavin001',
            url: 'https://atom.io/packages/atom-beutify',
            downloads: 4228040,
            stars: 4541,
            price: 6.75,
            selector: 'p2'
    ...
    function Package(data) {
        ...
        this.selector = data.selector; // ** REMEBER TO ADD THIS IF YOU ADDED IT TO THE DATA OBJECTS ** //
